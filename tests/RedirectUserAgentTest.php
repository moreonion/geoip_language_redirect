...
class RedirectUserAgentTest extends \DrupalUnitTestCase {
  ...
  public function testCommonUserAgentStrings() {
    $strings = array(
      'Mozilla/5.0 (X11; Linux x86_64; rv:17.0) Gecko/20130917 Firefox/17.0 Iceweasel/17.0.9' => TRUE,
      ...
      'Mozilla/4.0 (compatible; MSIE 6.01; Windows NT 6.0)' => TRUE,
      'Mozilla/5.0 (X11; Linux i686) AppleWebKit/534.33 (KHTML, like Gecko) Ubuntu/9.10 Chromium/13.0.752.0 Chrome/13.0.752.0 Safari/534.33' => TRUE,
    );
